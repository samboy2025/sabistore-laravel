        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="h-48 bg-gradient-to-br from-blue-500 to-purple-600 relative overflow-hidden">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center text-white">
                                ...
                                <p class="text-sm opacity-90">of Completion</p>
                            </div>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex space-x-3">
                            <a href="{{ route('buyer.certificates.show', $certificate) }}"
                               class="flex-1 inline-flex items-center justify-center px-3 py-2 border border-gray-300 text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('buyer.certificates.download', $certificate) }}"
                               class="flex-1 inline-flex items-center justify-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-700 transition-colors">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-3 pt-3 border-t border-gray-200">
                            <button onclick="copyVerificationLink('{{ $certificate->verification_url }}')"
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="text-gray-500 mb-4">Complete courses to earn certificates</p>
                    <a href="{{ route('buyer.courses') }}"
