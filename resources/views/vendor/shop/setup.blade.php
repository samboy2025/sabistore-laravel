...
@section('title', 'Shop Setup - SabiStore')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Complete Your Shop Setup</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div class="mt-4 grid grid-cols-3 gap-4 text-sm">
                ...
                <div class="text-center">
                    ...
                    <span class="text-red-600 font-medium">Shop Setup</span>
                </div>
                <div class="text-center">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <form method="POST" action="{{ route('vendor.shop.complete-setup') }}" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        minlength="20"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors"
                        placeholder="Tell customers about your business, products, and what makes you special (minimum 20 characters)..."
                    >{{ old('description', $shop->description ?? '') }}</textarea>
                    <p class="mt-1 text-xs text-gray-600">Minimum 20 characters required</p>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('whatsapp_number', $shop->whatsapp_number ?? auth()->user()->whatsapp_number ?? '') }}"
                        required
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors"
                ...
                <div>
                    <label for="bvn_nin" class="block text-sm font-medium text-gray-700 mb-2">
                        BVN or NIN <span class="text-red-500">*</span>
                    </label>
                    <input 
                        type="text" 
                        id="bvn_nin" 
                        name="bvn_nin" 
                        value="{{ old('bvn_nin', auth()->user()->bvn_nin ?? '') }}"
                        required
                        minlength="10"
                        maxlength="15"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-colors"
                    ...
                    >
                    <p class="mt-1 text-xs text-gray-600">Required for vendor verification and security purposes</p>
                    @error('bvn_nin')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="text-sm text-gray-500">
                                    ...
                                    <p class="text-xs">Choose a new file to replace</p>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                <div>
                    ...
                    @if($shop && $shop->banner_path)
                        <div class="mb-4">
                            <p class="text-sm text-gray-600 mb-2">Current Banner:</p>
                            <div class="flex items-start space-x-4">
                                <img src="{{ asset('storage/' . $shop->banner_path) }}" 
                                     alt="Current banner" 
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <p>Complete your shop setup to start selling. You can always update this information later from your dashboard.</p>
                    </div>
                </div>
            </div>
        </div>
